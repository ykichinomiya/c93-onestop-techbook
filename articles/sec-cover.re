...
【Step2. スライドをPDFファイルに変換する】
 ...
 2. ダイアログで、「イメージの品質」を「高」または「最高」にして、「次へ...」ボタンを押します。
 3. ファイル保存用のダイアログが出るので、ファイル名を指定してから「書き出す」ボタンを押します。

このとき、スライドの幅と高さがそのままPDFファイルの幅と高さになります。変更はできません。
@<br>{}
...
【Step3. PDFファイルの幅と高さを確認する】
 ...
 3. ダイアログが出るので、いちばん左のタブを選ぶと、PDFページの大きさ（例：18.81×26.29 cm）が表示されます（@<img>{cover-pdfsize2}）。
...
悪いデザイン例を見てみましょう。@<img>{cover-badexample}は実際の同人誌で使われた表紙です。あえてどこのサークルかは言いませんが、ひどいデザインです。タイトルを大きくしてる点は評価できるものの、目をひくものが何もなく、ひどいデザインです。印刷代を安くするために白黒にした@<fn>{cover-monocolor}ことを考慮しても、ひどいデザインです。事実、この同人誌はかなり売れ残ってしまいました。ひどいデザインの表紙が売上に悪影響を与えた実例です。泣ける…
